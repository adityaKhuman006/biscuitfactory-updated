    ...
    <div class="content-wrapper p-2">
        <div class="row">
            <div class="col-12 p-2">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Get Out</h4>

                        <!-- Show the form to add a product if no products exist -->
                        <form method="POST" action="{{ route('get.out.create') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <select name="company_id" class="form-select form-control-sm border-dark" required>
