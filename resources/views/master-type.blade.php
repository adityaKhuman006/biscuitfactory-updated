                    ...
                    <table class="table table-hover tab-pane">
                        ...
                        @foreach ($items as $key => $item)
                            <tr class="removeble-tr-{{ $item->id }}">
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <input type="text" class="border-0 update-sm-name" data-id='{{ $item->id }}'
                                           value="{{ $item->short_name }}">
                                </td>
                                <td>
                                    <input type="text" class="border-0 update-full-name" data-id='{{ $item->id }}'
...
<script>
    ...
    $(document).ready(function () {
        $(".update-sm-name").change(function () {
            var smName = $(this).val();
        ...
        $(".update-full-name").change(function () {
            var id = $(this).attr('data-id');
